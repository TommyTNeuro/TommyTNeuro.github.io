...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "repositories",
          description: "This is a collection of my repos that I&#39;ve worked on and GitHub stats.",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
            ...
            window.location.href = "/blog/2026/Why-your-brain-runs-out-of-stream/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("/assets/pdf/Thomas-Roberts_Academic_CV.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%74%6F%6D%6D%79%74%6B%72%6F%62%65%72%74%73@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/TommyTNeuro", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/TommyTNeuro", "_blank");
        },
      },{
        id: 'social-medium',
        title: 'Medium',
